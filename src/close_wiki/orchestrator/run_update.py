"""Incremental update pipeline for `close-wiki update`.
...
from close_wiki.models.contracts import AnalysisResult, FileManifest, LLMConfig
from close_wiki.orchestrator.run_digest import run_digest, _combine_results
